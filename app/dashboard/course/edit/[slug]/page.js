                    ...
                    <div className="lg:col-span-2 space-y-8">
                        ...
                        <FormSection title="আউটকাম ও রিকোয়ারমেন্ট" icon={<Target className="mr-3 h-6 w-6 text-indigo-600"/>}>
                            <div>
                                ...
                                <button type="button" onClick={() => addListItem('outcomes')} className="text-sm font-semibold text-indigo-600"><Plus size={16} className="inline mr-1"/> আউটকাম যোগ করুন</button>
                            </div>
                            <div>
                                ...
                                <button type="button" onClick={() => addListItem('requirements')} className="text-sm font-semibold text-indigo-600"><Plus size={16} className="inline mr-1"/> রিকোয়ারমেন্ট যোগ করুন</button>
                            </div>
                        </FormSection>
                                ...
                                {syllabus.map((s, si) => (
                                    <div key={s.id} className="border bg-slate-50 p-4 rounded-lg">
                                        ...
                                        <div className="space-y-4 pl-2 border-l-2 border-slate-200">
                                                ...
                                                <div key={l.id} className="bg-white p-3 rounded-md border">
                                                    ...
                                                    <div className="mt-3 pl-10">
                                                        <div className="flex items-center gap-2 mb-2">
                                                            ...
                                                            <button type="button" onClick={() => handleLessonChange(s.id, l.id, 'videoSource', 'upload')} className={`px-2 py-1 text-xs rounded ${l.videoSource === 'upload' ? 'bg-indigo-600 text-white' : 'bg-slate-200'}`}>Upload</button>
                                                            <button type="button" onClick={() => handleLessonChange(s.id, l.id, 'videoSource', 'link')} className={`px-2 py-1 text-xs rounded ${l.videoSource === 'link' ? 'bg-indigo-600 text-white' : 'bg-slate-200'}`}>Link</button>
                                                        </div>
                                            ...
                                            <button type="button" onClick={() => addLesson(s.id)} className="text-sm font-semibold text-indigo-600 ml-10"><Plus size={16} className="inline mr-1"/> Add Lesson</button>
                                        </div>
                                    </div>
                                ))}
                                <button type="button" onClick={addSection} className="w-full text-center py-3 border-2 border-dashed rounded-lg text-indigo-600 font-semibold hover:bg-indigo-50">Add Section</button>
                            </div>
                        </FormSection>
                    </div>
